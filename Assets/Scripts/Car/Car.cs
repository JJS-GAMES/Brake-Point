...
public class Car : MonoBehaviour
{
    ...
    private void Awake() // Временно в Update для эскперементов, в будущем ОБЯЗАТЕЛЬНО вернуть в Awake!
    {
        ...
        _carController.Init(_groundCheck, _carSettings.IsWorkingEngine, _carSettings.Mass, _carSettings.EngineMaxSpeed, _carSettings.CoastMaxSpeed, _carSettings.Acceleration, _carSettings.AirSlowEffect, _carSettings.AirBoostEffect, _carSettings.FrontSuspensionStiffness, _carSettings.BackSuspensionStiffness);
